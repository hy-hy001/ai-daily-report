# AI 日报精选 TOP 10
**2026-08-03** | 数据来源：[AIHOT](https://aihot.virxact.com)

---

### 1. 字节发布 Seedance 2.5：单次生成 30 秒视频，支持多模态参考与精准编辑
🔴 评分 **80** · 字节 Seed：Research Feed（网页内嵌数据） · 3 天前
...
🟠 评分 **78** · X：Artificial Analysis (@ArtificialAnlys) · 2 天前
...
🟠 评分 **78** · Hacker News 热门（buzzing.cc 中文翻译） · 2 天前
...
🟠 评分 **76** · Google Research：Blog（网页） · 4 天前
...
🟠 评分 **75** · X：阿易 AI Notes (@AYi_AInotes) · 12 小时前
...
### 7. GLM 5.2 助 Hugging Face 抵御秘密模型攻击
...
### 8. animated-voiceover 开源：一人干翻动画工作室
...
### 9. 面壁智能ALIGN：自动对齐智能体与环境接口
🟠 评分 **75** · X：面壁智能 OpenBMB (@OpenBMB) · 2 天前
