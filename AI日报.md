# AI 日报精选 TOP 10
**2026-07-19** | 数据来源：[AIHOT](https://aihot.virxact.com)

---

### 1. xAI 起诉 Grok 用户制作儿童性虐待内容，不再否认模型被滥用
🔴 评分 **87** · Ars Technica：AI（RSS） · 2 天前
...
### 2. Grok 推出 Automations 功能：定时或邮件触发，自动执行任务并汇报结果
🔴 评分 **85** · xAI：News（网页） · 3 天前
...
🔗 [阅读原文](https://x.ai/news/grok-automations)
...
### 4. 月之暗面在GTC 2026披露Kimi K2.5技术路线：用MuonClip、线性注意力与Agent Swarm重构三大基础组件
🔴 评分 **81** · X：宝玉 (@dotey) · 1 天前
...
### 5. Schema Harness 在 ARC-AGI-3 公开集上取得约 99% 成绩
...
### 6. 欧盟裁定 Google 必须向竞争对手开放 Android 和 Search，影响 Gemini 等 AI 服务
🟠 评分 **78** · The Verge：AI（RSS） · 2 天前
...
### 7. 台积电上调2026年资本支出预测至600~640亿美元，A14制程进展顺利
🟠 评分 **78** · IT之家（RSS） · 2 天前
...
🔗 [阅读原文](https://www.ithome.com/0/977/544.htm)

---

### 8. 阿里Qwen将集成至Apple Intelligence服务中国用户
🟠 评分 **78** · X：X.PIN (@thexpin) · 3 天前
...
### 9. HYPIC：小红书联合北大、上交提出首个混合注意力大模型位置无关缓存系统
...
🔗 [阅读原文](https://mp.weixin.qq.com/s/RWveWvw9yBH6YQINBQ-XjA)

---

### 10. Telegram 无服务器架构
🟠 评分 **77** · Hacker News 热门（buzzing.cc 中文翻译） · 3 天前
