# AI 日报精选 TOP 10
**2026-08-02** | 数据来源：[AIHOT](https://aihot.virxact.com)

---

### 1. 字节发布 Seedance 2.5：单次生成 30 秒视频，支持多模态参考与精准编辑
🔴 评分 **80** · 字节 Seed：Research Feed（网页内嵌数据） · 2 天前
...
### 2. DeepSeek V4 Flash 0731 开源，登顶开源模型前三
🟠 评分 **78** · X：Artificial Analysis (@ArtificialAnlys) · 1 天前
...
### 4. Show HN：将 DeepSeek 整合到 GPT-OSS 中不会带来审查机制
...
### 5. Science One Framework：通过 Chain-of-Evidence 实现可验证的自主科研框架
🟠 评分 **76** · Google Research：Blog（网页） · 3 天前
...
### 6. GLM 5.2 助 Hugging Face 抵御秘密模型攻击
🟠 评分 **75** · X：阿易 AI Notes (@AYi_AInotes) · 18 小时前
...
### 8. 面壁智能ALIGN：自动对齐智能体与环境接口
🟠 评分 **75** · X：面壁智能 OpenBMB (@OpenBMB) · 1 天前
...
🔗 [阅读原文](https://www.ithome.com/0/983/974.htm)

---

### 10. Replit Design 发布：AI 赋能设计愿景
🟠 评分 **75** · X：Replit (@Replit) · 3 天前
...
🔗 [阅读原文](https://x.com/Replit/status/2082568269119062019)
